...
func TestNewOptionFunc(t *testing.T) {
	...
	routes := r.Routes()
	assertRoutePresent(t, routes, RouteInfo{Path: "/test1", Method: "GET", Handler: "github.com/LambdaTest/gin.handlerTest1"})
	assertRoutePresent(t, routes, RouteInfo{Path: "/test2", Method: "GET", Handler: "github.com/LambdaTest/gin.handlerTest2"})
}
